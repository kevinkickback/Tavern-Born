...
* Stat-management previews now retain active typed effects, subclass spellcasting limits follow the selected subclass, reusable build copies begin with full class resources, 2014 Paladin Channel Divinity uses the correct capacity, and action lists resolve class and feat rules from loaded source data
