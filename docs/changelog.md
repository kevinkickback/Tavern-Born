...
* Source-derived actions now exclude passive race, feat, and class prose; every source/manual action or effect group can collapse independently, and cross-page setup links temporarily flash their destination in either ruleset
