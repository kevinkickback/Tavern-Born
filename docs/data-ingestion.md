...
references and missing, duplicate, or stale approvals. `--verify` compares generated bytes with an
existing output and rejects missing, changed, or unexpected managed files. A snapshot marked
