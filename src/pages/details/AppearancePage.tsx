      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor={ageId} className="mb-2 block">
                Age
              </Label>
              <Input
                id={ageId}
            ...
            <div>
              <Label htmlFor={heightId} className="mb-2 block">
                Height
              </Label>
              <Input
                id={heightId}
            ...
            <div>
              <Label htmlFor={weightId} className="mb-2 block">
                Weight
              </Label>
              <Input
                id={weightId}
            ...
            <div>
              <Label htmlFor={sizeId} className="mb-2 block">
                Size
              </Label>
              <Input id={sizeId} placeholder="Medium" disabled />
            </div>
          </div>
          ...
          <div>
            <Label htmlFor={hairId} className="mb-2 block">
              Hair
            </Label>
            <Input
              id={hairId}
          ...
          <div>
            <Label htmlFor={skinId} className="mb-2 block">
              Skin / Complexion
            </Label>
            <Input
              id={skinId}
