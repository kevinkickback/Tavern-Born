...
export const SOURCE_FALLBACKS: Record<string, SourceFallback> = {
  ALCurseOfStrahd: {
    name: 'AL: Curse of Strahd',
    group: 'organized-play',
    published: '2016-03-01',
  },
  ALElementalEvil: {
    name: 'AL: Elemental Evil',
    group: 'organized-play',
    published: '2015-03-01',
  },
  ALRageOfDemons: {
    name: 'AL: Rage of Demons',
    group: 'organized-play',
  ...
  'HAT-LMI': {
    name: 'Hunt: A Board Game — Magic Items',
    group: 'supplement-alt',
  },
  MCV2DC: {
    name: 'Monstrous Compendium Vol. 2: Dragonlance Creatures',
    group: 'supplement-alt',
    published: '2022-12-05',
  },
  RoTOS: {
    name: 'Rise of Tiamat Online Supplement',
    group: 'supplement-alt',
