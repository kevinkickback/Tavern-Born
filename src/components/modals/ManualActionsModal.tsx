...
interface ManualActionsModalProps {
  open: boolean
...
export function ManualActionsModal({ open, onOpenChange }: ManualActionsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto border-border bg-workspace-detail sm:max-w-3xl">
        <DialogHeader>
